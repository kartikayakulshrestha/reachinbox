...
const Createral = () => {
  ...
  console.log(threadstoreData,"in central")
  ...
  return (
    ...
    {threadstoreId === -1 ? (
  <div className={`border mx-8 rounded-md my-3 ${darkview?"text-white border-[#343A40] bg-[#141517]":"text-black bg-white"}`}>
    <div className="p-4">
      <div className="flex justify-between py-4">
        <div className="space-y-2">
          <div className={`${darkview?"text-white":"text-black"} font-bold`}>{"New Product Launch"}</div>
          <div className={`text-sm ${darkview?"text-[#AEAEAE]":"text-[#637381]"}`}>from: {"jeanne@icloud.com : lennon.j@mail.com"}</div>
          <div className={`text-sm ${darkview?"text-[#AEAEAE]":"text-[#637381]"}`}>to: {"lennon.j@mail.com"}</div>
        </div>
        <div className={`text-sm ${darkview?"text-[#7F7F7F]":"text-[#637381]"}`}>20 June 2022 : 9:16 AM</div>
      </div>
      <div className={`py-4 w-2/3 ${darkview?"text-[#E1E0E0]":"text-[#172B4D]"}`}>
        Hi <span>&#10100;</span>First Name<span>&#10101;</span> <br /> <br />
...
) : Array.isArray(threadstoreData) && threadstoreData.length ? (
  threadstoreData.map((e) => {
    ...
    return (
      <div key={e.id} className={`border mx-8 rounded-md my-5 ${darkview?"text-white border-[#343A40] bg-[#141517]":"text-black bg-white"}`}>
        <div className="p-4">
          <div className="flex justify-between py-4">
            <div className="space-y-2">
              <div className={`${darkview?"text-white":"text-black"} font-bold`}>{e.subject}</div>
              <div className={`text-sm ${darkview?"text-[#AEAEAE]":"text-[#637381]"}`}>from: {e.fromEmail}</div>
              <div className={`text-sm ${darkview?"text-[#AEAEAE]":"text-[#637381]"}`}>to: {e.toEmail}</div>
            </div>
            <div className={`text-sm ${darkview?"text-[#7F7F7F]":"text-[#637381]"}`}>{formattedDate}</div>
          </div>
          <div className={`py-4 w-2/3 ${darkview?"text-[#E1E0E0]":"text-[#172B4D]"}`} dangerouslySetInnerHTML={{ __html: e.body }} />
...
<div className="py-8 mx-8 relative flex justify-center items-center">
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          ...
          <div className={ ` px-4 py-1 text-sm flex items-center space-x-1 ${darkview?"text-white bg-[#171819]":"text-black bg-[#E0E0E0]"}`} >
            ...
            <span className="text-blue-500"> {threadstoreId===-1?"4":threadstoreData.length} </span>
            <span>replies</span>
          </div>
        </div>
      </div>
